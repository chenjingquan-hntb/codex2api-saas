...
import { LayoutDashboard, Users, Activity, Settings, Server, Languages, Globe, BookOpen, KeyRound, Image as ImageIcon, ShieldAlert, ExternalLink, ChevronLeft, Palette, Sun, Moon, LogOut, Download, Loader2, RefreshCw, Menu, X, CircleDollarSign, Braces, Wallet } from 'lucide-react'
...
const navDefs: NavDef[] = [
  ...
  { to: '/control-panel', labelKey: 'nav.controlPanel', icon: <Wallet className="size-[18px]" />, activePrefix: '/control-panel' },
